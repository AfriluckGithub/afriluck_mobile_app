        ...
        >
          <div className="w-full flex justify-between items-center text-md">
            ...
            {section.started ? (
              ...
              <div className="flex items-center space-x-2 bg-[#d0f8ff] text-xs md:text-base text-primary px-6 py-3 rounded-tr-xl rounded-bl-xl lg:w-40 md:w-auto sm:w-auto">
