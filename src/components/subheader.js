...
const Subheader = ({ title = "Default", image, onIconClick }) => {
  ...
  return (
    <div className="flex flex-row justify-center items-center w-full h-auto bg-white border-b border-border-default px-48 fixed py-6    top-0 left-0 right-0 z-50">
