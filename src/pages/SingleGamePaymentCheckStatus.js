      ...
      <div className="flex flex-col w-full h-screen p-5">
        ...
        <div className="flex flex-col justify-center items-center h-full w-full p-5 rounded-lg">
          ...
          <p className="text-center text-sm">
            Congratulations in advance. Thanks for your contribution. For any
            prize below GHS 12,000.00, wins will be redeemed instantly to your
            wins account. For any prize equal or above GHS 12,000.00, Please
            contact Afriluck for verification
          </p>
        </div>
      </div>
      <footer className="flex flex-col h-28 m-5 absolute bottom-auto left-0 right-0">
        <div className="flex flex-row w-auto mt-10">
          <button
            ...
            className="text-white font-bold rounded-lg w-full h-12"
          >
            Okay
          </button>
        </div>
